...
namespace WebApplication1.Controllers
{
    public class JobCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "JobCategoryId,JobCategory1,Description")] JobCategory jobCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "JobCategoryId,JobCategory1,Description")] JobCategory jobCategory)
        {
            if (ModelState.IsValid)
            {
